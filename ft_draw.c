...
/*   Updated: 2016/04/27 18:22:08 by lherbelo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			square(t_fdf *fdf, t_coord pt1, t_coord pt2, t_coord pt3)
{
	...
	to_iso(fdf, &pt2);
	to_iso(fdf, &pt3);
	line(fdf, &pt1, &pt2, ft_color(ft_set_color(fdf, pt1.z, pt2.z)));
	printf("1 = %lf\n", fdf->diff);
	line(fdf, &pt1, &pt3, ft_color(ft_set_color(fdf, pt1.z, pt3.z)));
	printf("2 = %lf\n", fdf->diff);
}
